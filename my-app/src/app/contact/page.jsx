...
// import styles from '@/styles/SocialButtons.module2.css'
import '@/styles/SocialButtons.module2.css'
...
function SignupFormDemo() {
    ...
    return (
        <div className="w-[75%] mx-auto rounded-none md:rounded-2xl md:p-8 shadow-input dark:bg-black  mt-[130px] flex  m-auto items-center justify-center ">
            <div className=" flex flex-col w-[50%] px-10 gap-10 z-10">
                <h1 className=" text-4xl">
                    Lets Talk
                </h1>
                <p className=" text-base text-neutral-700 ">If you want learn more about services and solutions, complete the form and one of our experts will be in touch shortly.</p>
                <div className={styles.main}>
                    <div className={styles.up} >
                        <button className={styles.card1}>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" width="30px" height="30px" fillRule="nonzero" className={styles.instagram}>
                        ...
                        <button className={styles.card2}>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="30px" height="30px" className={styles.twitter}>
                    ...
                    <div className={styles.down}>
                        <button className={styles.card3}>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30" width="30px" height="30px" className={styles.github}>
                        ...
                        <button className={styles.card4}>
                            <svg height="30px" width="30px" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" className={styles.discord}>
                ...
                <form className="my-8" onSubmit={handleSubmit}>
                    ...
                    <LabelInputContainer className="mb-4">
                        ...
                        <textarea
                            ...
                            className="flex h-[100px] w-full border-none bg-gray-50 dark:bg-zinc-800 text-black dark:text-white shadow-input rounded-md px-3 py-2 text-sm  file:border-0 file:bg-transparent 
