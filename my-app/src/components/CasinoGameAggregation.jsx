...
function CasinoGameAggregation() {
    return (
        <div className="h-auto w-full flex items-center justify-center ">
            <div className="flex flex-col md:flex-row w-full max-w-6xl mx-auto items-center justify-between mt-16 space-y-8 md:space-y-0 sm:gap-40 gap-10 m-auto">
                ...
                <div className="flex flex-col gap-10 w-full md:w-1/2 items-center md:items-start justify-center h-full  sm:px-6 px-4  text-center ">
                    <div>
                        <Image src={casinogameagricon} alt="khihih" className=" sm:h-[50px] sm:w-[50px] w-[80px] h-[80px]" />
                    </div>
                    <h1 className="sm:text-5xl text-4xl  font-bold text-center md:text-left flex items-center justify-center">Casino Game Aggregation</h1>
                    ...
                    <h2 className=" cursor-pointer">Learn more →</h2>
                </div>
